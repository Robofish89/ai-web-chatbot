...
(function () {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      .vdv-header-logo-wrap {
        display: flex;
        justify-content: center;
        align-items: center;
      }

      /* Rectangle Val de Vie logo – size as in your screenshot */
      .vdv-chat-title-logo {
        height: 54px;
        width: auto;
        object-fit: contain;
      ...
      /* Divider aligned perfectly with logo width */
      .vdv-header-divider {
        margin-top: 2px;
        height: 3px;
        display: flex;
      ...
      .vdv-header-divider::after {
        content: "";
        display: block;
        width: 220px; /* tuned to be visually aligned with logo */
        max-width: 80%;
        height: 3px;
        background: var(--vdv-bg);
        border-radius: 2px;
      ...
      /* Inputs: no overhang, perfectly aligned */
      .vdv-prechat-input {
        width: 100%;
        border-radius: 999px;
